...
make deploy-ui                                # Build + sync UI to S3 + invalidate CloudFront (excludes ark_demo/*);
                                              # delegates to scripts/deploy-ui.sh, the same recipe deploy_ui.yml runs
