...
[`flip-api/AGENTS.md`](flip-api/AGENTS.md#end-to-end-smoke-test).
...
regeneration chains and their verification gate: [`fl-tutorials/AGENTS.md`](fl-tutorials/AGENTS.md).
FL image building (`make build-fl`, the `:dev` tag): [`fl-services/AGENTS.md`](fl-services/AGENTS.md).
