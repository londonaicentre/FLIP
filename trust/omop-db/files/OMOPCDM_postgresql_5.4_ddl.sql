...
CREATE TABLE IF NOT EXISTS VISIT_DETAIL (
			visit_detail_id SERIAL PRIMARY KEY NOT NULL,
			person_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS DEVICE_EXPOSURE (
			device_exposure_id SERIAL PRIMARY KEY NOT NULL,
			person_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS NOTE_NLP (
			note_nlp_id SERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS DOSE_ERA (
			dose_era_id SERIAL PRIMARY KEY NOT NULL,
			person_id integer NOT NULL,
			drug_concept_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS COHORT_DEFINITION (
			cohort_definition_id SERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS IMAGE_OCCURRENCE (
			image_occurrence_id SERIAL PRIMARY KEY NOT NULL,
			person_id integer NOT NULL,
			procedure_occurrence_id integer,
			visit_occurrence_id integer,
			anatomic_site_concept_id integer,
			wadors_uri varchar(512),
			local_path varchar(512),
			image_occurrence_date DATE NOT NULL,
			image_study_uid varchar(64),
			image_series_uid varchar(64),
			modality_concept_id integer );

ALTER TABLE IMAGE_OCCURRENCE ADD COLUMN IF NOT EXISTS accession_id varchar(255) NULL;

CREATE TABLE IF NOT EXISTS IMAGE_FEATURE (
			image_feature_id SERIAL PRIMARY KEY,
			person_id integer NOT NULL,
