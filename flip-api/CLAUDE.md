...
[`fl-tutorials/CLAUDE.md`](../fl-tutorials/CLAUDE.md) for `make build-fl` / `:dev` image details.
...
[`CLAUDE.md`](../CLAUDE.md#key-environment-variables); FL knobs live in
[`../fl-services/CLAUDE.md`](../fl-services/CLAUDE.md).
