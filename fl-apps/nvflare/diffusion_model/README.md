...
- `post_validation` → `flip.nvflare.components.CleanupJobDir` (job-workspace cleanup — this job broadcasts it at the end of each phase, steps 4 and 7 above; imaging retention is trust-side, FLIP#1050)
