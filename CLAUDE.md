...
Never append a "Generated by Claude Code" attribution footer (or any equivalent
tool-attribution line) to GitHub comments — PR comments, review comments, review
replies, and issue comments alike. Some agent harnesses inject this footer by
default; it is not wanted in this repository. Write the comment body and stop.
