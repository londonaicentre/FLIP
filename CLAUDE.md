...
5. Install AWS Session Manager plugin (for SSH-over-SSM access)
...
- SSH access via AWS SSM Session Manager only (no port 22 open). See `deploy/providers/AWS/CLAUDE.md` for full details.
