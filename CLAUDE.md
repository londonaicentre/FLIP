...
both-backends switch: [`flip-api/CLAUDE.md`](flip-api/CLAUDE.md#end-to-end-smoke-test).
...
[`fl-tutorials/CLAUDE.md`](fl-tutorials/CLAUDE.md). FL image building (`make build-fl`, the `:dev`
tag): [`fl-services/CLAUDE.md`](fl-services/CLAUDE.md).
...
[`trust/CLAUDE.md`](trust/CLAUDE.md#trust-data-seeding-and-versioning).
