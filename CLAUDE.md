...
│   └── providers/
│       ├── nvflare/    # NVFLARE network provisioning: Makefile (provision/-2-nets/-additional-client/-stag/-prod/upload-kits-to-s3) + net-*_project_*.yml + scripts/ (provision-network, provision-additional-client) + workspace/ (provisioned startup kits, gitignored)
