...
The writer replaces plastimatch (FLIP#1261): a pure pydicom + nibabel path that needs no root, no
binaries, and — the property a tables-only dataset is built on — produces the same bytes on every run,
