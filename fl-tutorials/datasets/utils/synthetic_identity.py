...
"""Synthetic patient identities that are pure functions of a case id (FLIP#1221).

A public research volume (MSD spleen, MSD brain tumour) carries no patient: no name, no NHS number, no
