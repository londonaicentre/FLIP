...
`fl-services/` (see [`../fl-services/CLAUDE.md`](../fl-services/CLAUDE.md)).
...
[`../flip-api/CLAUDE.md`](../flip-api/CLAUDE.md#end-to-end-smoke-test). The spleen
