...
from the raw Ark6 file (`LOAD_BACKBONE_ONLY=true` is applied there, host-side — the heads start fresh),
and wraps it in `ArkPlusNVFlareWrapper` (which adapts Ark+'s
