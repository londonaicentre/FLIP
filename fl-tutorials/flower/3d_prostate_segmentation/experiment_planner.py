...
# https://github.com/yoviny/MambaX-Net/blob/main/mambax_net/utilities/experiment_planner.py,
...
#    Modifications: Adapted for MambaX-Net project (https://github.com/yoviny/MambaX-Net) with custom experiment planning
