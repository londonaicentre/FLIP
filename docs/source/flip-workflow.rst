...
.. figure:: assets/support/flip_walkthrough-cohort_query.png
   :align: center
...
.. figure:: assets/support/flip_walkthrough-approve_project.png
   :align: center
...
.. note::
   ...
   A project created with 'Includes imaging data' turned off — a tabular-only cohort — skips the imaging stages that follow. Approval creates no XNAT project at any Trust and pulls nothing from PACS, there are no images to enrich, and training reads the OMOP cohort dataframe alone. The 'Dataset enriched' confirmation before training still has to be switched on; it is reworded to a confirmation that the data is ready. Like 'Convert DICOMs to NIfTI', the option is fixed when the project is created.
...
.. figure:: assets/support/flip_walkthrough-enrich_images.png
   :align: center
...
.. figure:: assets/support/flip_walkthrough-upload_collateral.png
   :align: center
...
.. figure:: assets/support/flip_walkthrough-start_job_A.png
   :align: center
...
.. figure:: assets/support/flip_walkthrough-finish_job.png
   :align: center

   Federated job finish.
