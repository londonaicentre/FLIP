...
For more information about currently supported apps, visit the in-tree FLIP tutorials at `fl-apps/tutorials <https://github.com/londonaicentre/FLIP/tree/main/fl-apps/tutorials>`_.

For Flower examples still maintained in the separate repo, see `flip-fl-base-flower <https://github.com/londonaicentre/flip-fl-base-flower/tree/main/src>`_.

Examples of how the same job type (standard -> federated averaging) can run different user-uploaded applications are:

- `xray_classification <https://github.com/londonaicentre/FLIP/tree/main/fl-apps/tutorials/image_classification/xray_classification>`_
- `3d_spleen_segmentation <https://github.com/londonaicentre/FLIP/tree/main/fl-apps/tutorials/image_segmentation/3d_spleen_segmentation>`_
...
to be via the flip-utils package (see `https://github.com/londonaicentre/FLIP/tree/main/flip-utils/flip`).
