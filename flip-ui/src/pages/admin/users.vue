...
<template>
    <!-- De-carded shell: edge-to-edge under the admin chip-tab bar. Keeps the old
         AiCard's load-bearing overflow clipping + white canvas, drops the chrome. -->
    <div data-test="users-shell" class="flex w-full h-full overflow-hidden bg-white dark:bg-dark-canvas">
