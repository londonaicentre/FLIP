...
<template>
    <div class="flex flex-col w-full">
        <Transition name="fade" mode="out-in">
            ...
            <AiCard v-else class="w-full space-y-2">
                ...
                <div class="relative px-4 pb-4 pt-0 space-y-2 xl:columns-2 gap-x-2">
                    <div
                                                    ...
                                                    <span class="flex flex-col w-full shrink">
                                                        ...
                                                        >
                                                            ...
                                                            <p
                                                                ...
                                                                class="text-xs font-normal text-gray-400 dark:text-gray-200 shrink line-clamp-1"
