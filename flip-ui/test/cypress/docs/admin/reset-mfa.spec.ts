...
// Records docs/source/assets/admin/reset-mfa.gif.
// resetUserMfa POSTs to /users/{id}/mfa/reset (see src/services/user-service.ts).

describe("docs: reset user MFA", () => {
    it("resets a user's MFA enrolment", () => {
        cy.login();
        ...
        cy.intercept("POST", "/users/*/mfa/reset", { statusCode: 200 }).as("mfaReset");
